    ...
    methods: {
          ...
          d => {
            if (d.success) {
              ...
              this.getPopup({
                width: 550,
                height: 200,
                label: bbn._("Script package.json"),
      ...
      deleteVersion(row, col, id) {/*
        ...
        this.getPopup({
          width: 500,
          height: 200,
          label: bbn._("Remove version in library") + " " + this.source.title,
            ...
            this.post(this.tableVersions.management.source.root + 'data/version/add', {
              ...
              if (d.data && (d.data.folders_versions !== undefined)) {
                this.getPopup({
                  height: '200px',
                  width: '450px',
                  label: bbn._('The following version already exists') + ": " + this.tableVersions.source.name,
                ...
                this.confirm(this.tableVersions.management.source.lng.versionGithubImport, () => {
                  this.post(this.tableVersions.management.source.root + 'github/versions', { url: d.data.github }, ele => {
                    this.getPopup({
                      height: '25%',
                      width: '50%',
                      label: this.tableVersions.management.source.lng.githubVersion,
