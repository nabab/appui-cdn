...
<script type="text/html" id="i3h34uefn94uh3rnfe9sfd23u">
  ...
  <div class="k-block appui-block appui-w-100">
    ...
    <div class="appui-block appui-w-100" style="padding: 10px">
      ...
      <div class="appui-form-label"><strong><?=_("Description:")?></strong></div>
      <div class="appui-form-field">
