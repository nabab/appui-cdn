<!-- New library -->
<script type="text/html" id="nasdyhi234y89asdnkasdh9854nkasdi">
  <div id="lkasu9rnos9ufsdfw9udfsdy8923" style="display: none">
    ...
    <div class="bbn-form-field">
      <input class="bbn-textbox" name="name" data-bind="value: name" type="text">
    </div>
